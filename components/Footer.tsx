...
export default function Footer() {
    return (
        <div className="bg-gray-100">
            <div className='container mx-auto h-44 w-full flex justify-between' style={{
            alignItems: 'center'}
            }>
                <div>
                    <img src='/UniqueCode.png' height={52} width={52} className="inline-block" />
                    <h1 className='font-thin text-xl inline-block' >UniqueCode</h1>
                </div>
                <div className='text-center font-thin text-xl'>
                    <h1>2021 &copy; UniqueCode All Right Reserved.<br />대표 : 송찬우 | 사업자등록번호 : 799-60-00477</h1>
                </div>
                <div >
